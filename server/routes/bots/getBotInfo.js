    ...
    if (bot.type === 'pending')
      ...
      return res.status(200).send({
        ...
        avatar:
          ...
          'https://cdn.discordapp.com/attachments/653733403841134600/976642199460659210/defaultUser.webp',
        botID: bot.botID,
        tags: bot.tags,
        prefix: bot.prefix,
      ...
      return res.status(400).send({
        message: 'Unable to find that Bot in our System, Has it been approved?',
        error: true,
        fatal: false,
        status: 400,
      });
